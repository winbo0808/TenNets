...
public class MyShopsOrdersItemListAdapter extends BaseAdapter {
	private Context mContext;
	private List<Map<String, String>> list;
	private LayoutInflater inflater;

	public MyShopsOrdersItemListAdapter(Context mContext) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(
					R.layout.lv_my_shops_orders_item_list_item, null);
