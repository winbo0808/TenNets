...
public class MyCouponsListAdapter extends BaseAdapter {
	...
	public MyCouponsListAdapter(Context mContext) {
		super();
	...
	public View getView(int position, View convertView, ViewGroup arg2) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.lv_my_coupons_list_item,
					null);
			holder.tv_my_coupons_item_value1 = (TextView) convertView
					.findViewById(R.id.tv_my_coupons_item_value1);
	...
	class ViewHolder {
		TextView tv_my_coupons_item_value1;
